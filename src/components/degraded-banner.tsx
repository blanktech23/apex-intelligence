...
export function DegradedBanner() {
  ...
  return (
    <div className="relative z-50 flex items-center justify-center gap-3 bg-amber-500/15 border-b border-amber-500/20 pl-20 pr-4 lg:px-4 py-2.5 pt-[max(0.625rem,env(safe-area-inset-top))]">
