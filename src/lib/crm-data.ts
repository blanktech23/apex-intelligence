...
export const activities: Activity[] = [
  ...
  { id: "act-006", contactId: "con-010", dealId: "deal-001", type: "email", direction: "outbound", subject: "Welcome email + consultation info", description: "Sent automated welcome email with consultation booking link and pre-visit questionnaire.", date: "2026-03-18T09:15:00", agent: "ai", agentName: "Leads Agent", duration: null },
  ...
  { id: "act-015", contactId: "con-003", dealId: "deal-004", type: "email", direction: "outbound", subject: "Pre-consultation questionnaire", description: "Sent pre-visit questionnaire and project scope worksheet for Mar 25 consultation.", date: "2026-03-21T10:00:00", agent: "ai", agentName: "Leads Agent", duration: null },
