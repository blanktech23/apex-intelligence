...
export const roleConfigs: Record<Role, RoleConfig> = {
  owner: {
    ...
    sidebarItems: [
      "Dashboard", "Setup Guide", "Agents", "CRM", "Chat", "Projects", "Escalations", "Approvals", "Reports", "Business OS", "Settings",
  ...
  designer: {
    ...
    sidebarItems: [
      "Dashboard", "Setup Guide", "Agents", "Chat", "Projects", "Catalog", "Business OS",
  ...
  bookkeeper: {
    ...
    sidebarItems: [
      "Dashboard", "Setup Guide", "Agents", "CRM", "Chat", "Orders", "Commissions", "Reports", "Business OS",
  ...
  viewer: {
    ...
    sidebarItems: [
      "Dashboard", "Setup Guide", "Agents", "Chat", "Projects", "Orders", "Catalog", "Reports", "Business OS",
